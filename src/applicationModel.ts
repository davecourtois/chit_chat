...
export class ApplicationModel {
    ...
    initRooms() {
        ...
        this.eventHub.subscribe(
            ...
            (evt: any) => {
                ...
                let r: Room;
                if (room.type == 2) {
                    r = new Room(this.globular, null, RoomType.Public, room.name, room.subjects, null);
    ...
    login(
        ...
        this.globular.ressourceService
            ...
            .then((rsp: ressource.AuthenticateRsp) => {
                ...
                Room.globular = this.globular
                Room.removePaticipant(this.account.name)
                // Retreive user data...
                ...
                this.globular.storageService.createConnection(rqst, { token: token, application: application, domain: domain })
                    .then(() => {
                        ...
                        this.globular.storageService.open(rqst, { token: token, application: application, domain: domain })
                            .then(() => {
    ...
    createRoom(
        ...
        let room = new Room(this.globular, null, roomType, name, [subject], account);
